%%%
%%% calcOverturning_ND1.m
%%%
%%% Calculates the overturning circulation in ND1 coordinates.
%%%
...
glevs = [27.7:0.01:28.1 28.105:0.005:28.42 28.4225:0.0025:28.5];
Ng = length(glevs);
...
save([expname,'_MOC_ND1.mat'],'xx','yy','zz','zz_f','glevs', ... 
