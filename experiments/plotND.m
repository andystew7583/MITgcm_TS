...
%%% plotND.m
%%%
%%% Plots the neutral density from the time/zonal mean
...
[C,h]=contourf(YY/1000,ZZ/1000,gamma,200,'EdgeColor','None');
hold on;
[C,h]=contour(YY/1000,ZZ/1000,gamma,[27.6:0.1:28.8],'EdgeColor','w');
