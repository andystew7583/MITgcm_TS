...
%%%
function E = densDiff (ss_parcel,pt_parcel,pp_parcel,ss_cast,pt_cast,pp_cast,cast_len,pp_ref)
  ...
  ss_ref = interpCast(ss_cast,pp_cast,cast_len,pp_ref);
  pt_ref = interpCast(pt_cast,pp_cast,cast_len,pp_ref);
  
  %%% Compute density difference between parcel and referred point on cast,
  %%% if moved to pressure mid-way between the two
  E = densmdjwf(ss_parcel,pt_parcel,pp_mean) - densmdjwf(ss_ref,pt_ref,pp_mean);
