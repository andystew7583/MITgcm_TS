...
%    Nr = 53; %%% no. of z-gridpoints   
  ...
  %%% Set-up for Fram, 396x448x53, 144 processors, ~1km resolution
%   opt_file = 'linux_ia64_ifort+mpi_AFT'; %%% options file name
%   use_mpi = true; %%% set true for parallel processing
%   use_pbs = true; %%% set true for execution via PBS
%   sNx = 44; %%% no. of x-gridpoints per tile
%   sNy = 28; %%% no. of y-gridpoints per tile
%   nPx = 9; %%% no. of processors in x-direction
%   nPy = 16; %%% no. of processors in y-direction
%   Nr = 53; %%% no. of z-gridpoints

  %%% Set-up for Fram, 396x448x53, 288 processors, ~1km resolution
  opt_file = 'linux_ia64_ifort+mpi_AFT'; %%% options file name
  use_mpi = true; %%% set true for parallel processing
  use_pbs = true; %%% set true for execution via PBS
  sNx = 22; %%% no. of x-gridpoints per tile
  ...
  %%% Set-up for Fram, 396x448x53, 576 processors, ~1km resolution
%   opt_file = 'linux_ia64_ifort+mpi_AFT'; %%% options file name
%   use_mpi = true; %%% set true for parallel processing
%   use_pbs = true; %%% set true for execution via PBS
%   sNx = 22; %%% no. of x-gridpoints per tile
...
%   Nr = 53; %%% no. of z-gridpoints
  ...
  %%% Set-up for Fram, 792x896x53, 576 processors, ~0.5km resolution
%   opt_file = 'linux_ia64_ifort+mpi_AFT'; %%% options file name
%   use_mpi = true; %%% set true for parallel processing
%   use_pbs = true; %%% set true for execution via PBS
%   sNx = 44; %%% no. of x-gridpoints per tile
